        ...
        <div className="bg-gradient-to-br from-blue-900 via-blue-600 to-blue-400 min-h-screen">
            ...
            <main className="pt-28">
                ...
                >
                    ...
                    {/* Tombol Get Started */}
                    <button onClick={handleGetStarted} className="mt-6 bg-sky-500 text-white px-6 py-2 rounded-lg shadow-sm hover:scale-105 hover:shadow-sm hover:shadow-white hover:shadow-opacity-30 hover:from-blue-700 hover:to-blue-600 duration-200">
                        Daftar Member
                    </button>
                    <button onClick={handleDashboard} className="mt-6 bg-sky-400 text-white px-6 py-2 rounded-lg shadow-sm hover:scale-105 hover:shadow-sm hover:shadow-white hover:shadow-opacity-30 hover:from-blue-700 hover:to-blue-600 duration-200">
                        Dashboard Member
                    </button>
                </section>
            </main>
